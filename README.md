...
[[`Paper`](https://arxiv.org/abs/2401.07322)] [[`Dataset`](https://www.kaggle.com/datasets/hasibzunair/rsud20k-bangladesh-road-scene-understanding) [[`Demo`]([#4-demo](https://github.com/hasibzunair/RSUD20K?tab=readme-ov-file#5-demo))] [[`BibTeX`](#5-citation)]
...
**Here's a collage of video predictions of object detector trained on RSUD20K in action!**

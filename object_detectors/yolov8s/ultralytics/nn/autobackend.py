...
def check_class_names(names):
    ...
    Map imagenet class codes to human-readable names if required. Convert lists
    to dicts.
    """
...
class AutoBackend(nn.Module):
    ...
    def _apply_default_class_names(data):
        """Applies default class names to an input YAML file or returns
        numerical class names."""
    ...
    def _model_type(p="path/to/model.pt"):
        """This function takes a path to a model file and returns the model
        type.

...
"""Export a YOLOv8 PyTorch model to other formats. TensorFlow exports authored
by https://github.com/zldrobit.
...
class Exporter:
    ...
    def export_openvino(self, prefix=colorstr("OpenVINO:")):
        ...
        if self.args.int8:
            assert (
                self.args.data
            ), "INT8 export requires a data argument for calibration, i.e. 'data=coco8.yaml'"
    ...
    def export_edgetpu(self, tflite_model="", prefix=colorstr("Edge TPU:")):
        """YOLOv8 Edge TPU export https://coral.ai/docs/edgetpu/models-
        intro/."""
        LOGGER.warning(

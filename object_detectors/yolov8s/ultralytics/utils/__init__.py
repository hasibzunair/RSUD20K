...
def is_github_actions_ci() -> bool:
    """Determine if the current environment is a GitHub Actions CI Python
    runner.
...
def colorstr(*input):
    """Colors a string based on the provided color and style arguments.
    Utilizes ANSI escape codes. See
...
def clean_url(url):
    """Strip auth from URL, i.e. https://url.com/file.txt?auth ->
    https://url.com/file.txt."""
    url = (
...
def url2file(url):
    """Convert URL to filename, i.e. https://url.com/file.txt?auth ->
    file.txt."""
